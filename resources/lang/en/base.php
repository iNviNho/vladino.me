...
return [
    ...
    "summary" => "SUMMARY",
    "summarytext1" => "Proactive and dedicated software enginner with 6+ years-column of experience in web development.",
    ...
    "customwebsites1" => "Custom websites",
    "customwebsites2" => "Custom made websites using strict workflow starting with:
                        <ul>
